...
public class EmployeeManagementSystem {
    public static void main(String[] args) {
        Employee fullTimeEmployee = new FullTimeEmployee(1, "Aashi", 60000);
        Employee partTimeEmployee = new PartTimeEmployee(2, "Ayush", 0, 20, 25);
        Employee employeeWithDepartment = new EmployeeWithDepartment(3, "Sandhya", 88000, "HR");
