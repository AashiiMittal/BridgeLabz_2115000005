...
public class MainUniversityManagement {
    public static void main(String[] args) {
        Student student1 = new Student("Aashi");
        Student student2 = new Student("Ayush");
        Student student3 = new Student("Akrati");
        Professor professor1 = new Professor("Dr. Satyendra");
        Professor professor2 = new Professor("Dr. Sandhya");
        Course course1 = new Course("Arts 001");
