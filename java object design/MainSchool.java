...
public class MainSchool {
    public static void main(String[] args) {
        ...
        Student student1 = new Student("Aashi Mittal");
        Student student2 = new Student("Ayush Thapak");
        Student student3 = new Student("Akrati Gupta");
        Course course1 = new Course("Hindi");
