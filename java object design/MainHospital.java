...
public class MainHospital {
    public static void main(String[] args) {
        ...
        Doctor doctor1 = new Doctor("Dr. Aashi Mittal");
        Doctor doctor2 = new Doctor("Dr. Ayush Thapak");
        Patient patient1 = new Patient("Akrati Gupta");
        Patient patient2 = new Patient("Arpit Dubey");
        Patient patient3 = new Patient("Arya Sharma");
